...
/**
 * Vendored from React Bits (LiquidEther, JS+CSS variant), MIT.
 * GPU fluid simulation that renders cursor-driven color wisps on a
 * transparent canvas. Local adaptations: WebGL construction wrapped in
 * try/catch so environments without WebGL just render nothing.
 */
...
`;
    ...
    try {
      ...
      // No WebGL available (old browser, test env): render nothing.
      return undefined;
    }
