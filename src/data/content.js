const en = {
  ...
  careerTree: {
    ...
    flowers: [
      { id: 'wild-rift', name: 'Wild Rift', note: 'Grandmaster rank', desc: 'My ranked main: the place where a comeback, a tilt queue, and a well-timed reward all make immediate sense.' },
      ...
      { id: 'gta5', name: 'GTA 5', desc: 'A city-sized sandbox that is as fun to wander as it is to make trouble in.' },
  ...
  portfolio: {
    ...
    player: {
      ...
      games: [
        { name: 'Wild Rift', note: 'Grandmaster rank' },
...
const zh = {
  ...
  careerTree: {
    ...
    flowers: [
      { id: 'wild-rift', name: '激鬥峽谷', note: '宗師段位', desc: '我最常打的排位場；逆轉、上頭再排一場，還有獎勵該在何時出現，都能直接感受到。' },
      ...
      { id: 'valorant', name: 'Valorant', desc: '一回合裡，溝通和槍法同樣重要；資訊講清楚，隊友才接得住。' },
      { id: 'r6', name: '虹彩六號', desc: '聽見一個腳步聲，就可能要把整個進攻計畫重新排過。' },
      { id: 'gta5', name: 'GTA 5', desc: '在大城市裡隨意晃、找支線、惹點麻煩，都是它好玩的理由。' },
